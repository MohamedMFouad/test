...
<div class="product_layout_classic">
	...
	<?php if ( !post_password_required() ) : ?>
		...
		<div id="product-<?php the_ID(); ?>" <?php function_exists('wc_product_class')? wc_product_class( '', $product ) : post_class(); ?>>
			<div class="row">
		        <div class="large-12 xlarge-11 xxlarge-9 large-centered columns">
							...
							<div class="large-4 xlarge-5 xxlarge-5 large-push-0 columns">
								...
								<div class="product_infos">
									 ...
									 <div class="product_summary_middle">
										<?php
											if(has_term( 'Buy 1 get 1 Free', 'product_cat')) {
												echo "<span class='buyOneGetOne'> Buy 1 Get 1 </span>";
											}
									...
									<?php
									   ...
									   <?php 
										if ( has_term( 'Men', 'product_cat' ) && has_term( 'Men Bottoms', 'product_cat' ) ) {
											echo "<p id='sizeChartLink'><a href='https://www.magmasportswear.com/men-size-chart/#tab2' target='_blank'>What size am I?</a></p>";
											
										} elseif (has_term('Men', 'product_cat') 
											&& (has_term('Tops and T-shirts', 'product_cat') 
											|| has_term('Baselayers and Compression', 'product_cat')
											|| has_term('Zip Pullover', 'product_cat')
											|| has_term('Short Sleeves', 'product_cat')
											|| has_term('Long Sleeves', 'product_cat')
										)) {
											
											echo "<p id='sizeChartLink'><a href='https://www.magmasportswear.com/magma-size-charts-men/#tab1' target='_blank'>What size am I?</a></p>";
										} elseif( has_term( 'Women', 'product_cat' ) && has_term( 'leggings', 'product_cat' )) {
											echo "<p id='sizeChartLink'><a href='https://www.magmasportswear.com/magma-size-chart-women/#tab2' 	
											target='_blank'>What size am I?</a></p>";		
										} elseif (has_term('Women', 'product_cat') &&
													 (has_term('Women Bottoms', 'product_cat') ||
													   has_term('Pants', 'product_cat') ||
													 has_term('Shorts', 'product_cat') || 
													  has_term('Leggings', 'product_cat')
													 )) {
															echo "<p id='sizeChartLink'>
												<a href='https://www.magmasportswear.com/magma-size-chart-women/#tab2' 															target='_blank'>What size am I?</a></p>";
														} elseif (has_term('Women', 'product_cat') &&
														(has_term('Tops and Crews', 'product_cat') 
														|| has_term('Short Sleeve', 'product_cat')
														|| has_term('Long Sleeve', 'product_cat')
														|| has_term('Zip Pullover', 'product_cat')  
												 )) {
											echo "<p id='sizeChartLink'>
											<a href='https://www.magmasportswear.com/magma-size-chart-women/#tab1' 	
											target='_blank'>What size am I?</a></p>";
										}
									?>
