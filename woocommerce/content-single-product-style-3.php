<?php
	...
	add_action( 'woocommerce_single_product_notices', 'woocommerce_output_all_notices', 10 );
						...
						<div class="row">
							...
							<div class="medium-12 large-8 xxlarge-8 columns">
								...
								<div class="product_infos fixed">
									...
									<?php do_action( 'woocommerce_single_product_notices' ); ?>
										...
										do_action( 'woocommerce_single_product_summary_single_excerpt' ); ?>
											...
											<?php 
												if ( has_term( 'Men', 'product_cat' ) && has_term( 'Men Bottoms', 'product_cat' ) ) {
													...
													<a href='https://www.magmasportswear.com/magma-size-charts-men/#tab1' target='_blank'>What size am I?</a></p>";
												...
												<a href='https://www.magmasportswear.com/magma-size-chart-women/#tab2' 															target='_blank'>What size am I?</a></p>";
													...
													echo "<p id='sizeChartLink'><a href='https://www.magmasportswear.com/magma-size-chart-women/#tab1' 		
