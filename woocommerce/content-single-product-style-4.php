							...
							<div class="medium-12 large-8 xxlarge-8 columns">
								...
								<div class="product_infos fixed">
									...
									<?php do_action( 'woocommerce_single_product_summary_single_price' ); ?>
										...
										<?php if ( has_term( 'Men', 'product_cat' ) && has_term( 'Men Bottoms', 'product_cat' ) ) {
												echo "<p id='sizeChartLink'><a href='https://www.magmasportswear.com/magma-size-charts-men/#tab2' target='_blank'>What size am I?</a></p>";
												...
												echo "<p id='sizeChartLink'><a href='https://www.magmasportswear.com/magma-size-chart-women/#tab2' 															target='_blank'>What size am I?</a></p>";		
												...
												<a href='https://www.magmasportswear.com/magma-size-chart-women/#tab1' 															target='_blank'>What size am I?</a></p>";
											} elseif (has_term('Women', 'product_cat') &&
