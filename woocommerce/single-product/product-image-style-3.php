    ...
    <div class="product_images">
	    ...
	    <?php if ( $page_product_youtube ) : ?>
			...
			<?php
				...
				echo '<div class="product-image video" id="controller-navigation-image-' .$current_img.'">' 
				...
				echo '<div class="product-video-icon">
						...
						<a data-fresco-group="product-gallery" class="'.$modal_class.'" href="'.esc_url($page_product_youtube).'">
						<i class="spk-icon spk-icon-video-player"></i></a>
